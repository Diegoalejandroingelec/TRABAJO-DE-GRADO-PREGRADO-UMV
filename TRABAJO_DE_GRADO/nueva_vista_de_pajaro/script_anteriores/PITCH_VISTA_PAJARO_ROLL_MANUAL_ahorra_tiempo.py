...
def matriz_de_homeografia(coord_sup_izquierda,coord_sup_derecha,coord_inf_izquierda,coord_inf_derecha,img_patron,path_resultados,num_res,dim_resize,angulo_roll,coordenada_ini,coordenada_finn):
    ...
    limites_imagen.append(coordenadas_en_vista_de_pajaro(M,0,0))
    limites_imagen.append(coordenadas_en_vista_de_pajaro(M,(img_patron.shape[1]-1),0))
    limites_imagen.append(coordenadas_en_vista_de_pajaro(M,coordenada_ini,(img_patron.shape[0]-5)))
    limites_imagen.append(coordenadas_en_vista_de_pajaro(M,coordenada_finn,(img_patron.shape[0]-5)))
